...
function Gastos_fijos_mensuales() {
  return (
    <div className="bg-fondo-cuenta-principal h-auto rounded-xl text-sm divide-y-2 divide-fondo-cuenta">
      <div>
        <h1 className="text-center tracking-widest font-bold text-white">GASTOS MENSUALES FIJOS</h1>
      </div>
...
export default Gastos_fijos_mensuales
